(() => {
          ...
          function ae(t, s, o) {
                ...
                if ((a = n ? n(r, a) : a) !== e.PipsType.None) {
                  ...
                  (l.className = u(a, s.cssClasses.marker)),
                    ...
                    a > e.PipsType.NoValue &&
                      (((l = q(o, !1)).className = u(a, s.cssClasses.value)),
            ...
            function he(e) {
              e.fixed ||
                ...
                e.hover && se(C.move, c, ue, { hover: !0 }),
                e.drag &&
  ...
  (() => {
    ...
    function oe(e) {
      ...
      if (c) {
        ...
        if (
          ...
          (x = q),
            (v -=
              (p && E.visualViewport ? E.visualViewport.height : C[O]) -
              n.height),
            (v *= l ? 1 : -1);
        if (i === j || ((i === V || i === q) && r === F))
          (w = B),
            (h -=
              (p && E.visualViewport ? E.visualViewport.width : C[L]) -
              n.width),
            (h *= l ? 1 : -1);
      }
      var P,
    ...
    function tt() {
      ...
      e - Je < 20 &&
        ((Ze.isTouch = !1), document.removeEventListener("mousemove", tt)),
        (Je = e);
    }
    function st() {
    ...
    function dt(e) {
      ...
      return (
        !0 === e
          ? (t.className = Pe)
          : ((t.className = ke), Ge(e) ? t.appendChild(e) : ct(t, e)),
        t
      );
    }
    function pt(e, t) {
    ...
    const Mt = {
      ...
      on: function (...e) {
        ...
        function r(e) {
          ...
          if ((i.indexOf(e) < 0 && i.unshift(e), Lt(t).is(s))) n.apply(t, i);
          else {
            const e = Lt(t).parents();
            for (let t = 0; t < e.length; t += 1)
              Lt(e[t]).is(s) && n.apply(e[t], i);
          }
        }
        function a(e) {
      ...
      nextAll: function (e) {
        ...
        for (; s.nextElementSibling; ) {
          ...
          e ? Lt(n).is(e) && t.push(n) : t.push(n), (s = n);
        }
        return Lt(t);
      },
      prev: function (e) {
      ...
      parent: function (e) {
        ...
        for (let s = 0; s < this.length; s += 1)
          null !== this[s].parentNode &&
            (e
              ? Lt(this[s].parentNode).is(e) && t.push(this[s].parentNode)
      ...
      parents: function (e) {
        ...
        for (let s = 0; s < this.length; s += 1) {
          ...
          for (; n; )
            e ? Lt(n).is(e) && t.push(n) : t.push(n), (n = n.parentNode);
        }
        return Lt(t);
      },
      closest: function (e) {
    ...
    function Bt({ swiper: e, targetPosition: t, side: s }) {
      const n = Ct(),
        i = -e.translate;
      let r,
        a = null;
        ...
        if (
          ...
          if (0 === t) o[e ? "scrollLeft" : "scrollTop"] = -d;
            ...
            if (!r.support.smoothScroll)
              return (
                Bt({ swiper: r, targetPosition: -d, side: e ? "left" : "top" }),
                !0
              );
      ...
      slideTo: function (e = 0, t = this.params.speed, s = !0, n, i) {
        ...
        if (o.cssMode) {
          ...
          if (0 === t) {
            ...
            if (!r.support.smoothScroll)
              return (
                Bt({ swiper: r, targetPosition: s, side: e ? "left" : "top" }),
                !0
              );
    ...
    const os = {
        attachEvents: function () {
          ...
          (e.onTouchStart = Zt.bind(e)),
            ...
            (e.onClick = ss.bind(e)),
            n.touch && !is && (t.addEventListener("touchstart", rs), (is = !0)),
            as(e, "on");
        },
    ...
    const cs = {
      setBreakpoint: function () {
        ...
        u && s && e.changeDirection(), Vt(e.params, l);
    ...
    class ms {
      constructor(...e) {
        ...
        (n.__swiper__ = !0),
          (n.support = Gt()),
          (n.device = Ft({ userAgent: s.userAgent })),
          (n.browser = Rt()),
          (n.eventsListeners = {}),
      ...
      static installModule(e) {
        ms.prototype.__modules__ || (ms.prototype.__modules__ = []);
        const t = ms.prototype.__modules__;
        "function" == typeof e && t.indexOf(e) < 0 && t.push(e);
      }
      static use(e) {
        return Array.isArray(e)
          ? (e.forEach((e) => ms.installModule(e)), ms)
          : (ms.installModule(e), ms);
      }
    }
    Object.keys(fs).forEach((e) => {
      Object.keys(fs[e]).forEach((t) => {
        ms.prototype[t] = fs[e][t];
      });
    }),
      ms.use([
    ...
    function bs({ swiper: e, extendParams: t, on: s, emit: n }) {
      function i(t) {
        let s;
        return (
          t &&
      ...
      t({
        ...
        s("click", (t, s) => {
          const { $nextEl: i, $prevEl: r } = e.navigation,
            a = s.target;
          if (e.params.navigation.hideOnClick && !_t(a).is(r) && !_t(a).is(i)) {
            if (
              e.pagination &&
              e.params.pagination &&
    ...
    function ws({ swiper: e, extendParams: t, on: s, emit: n }) {
      ...
      function c() {
        ...
        if (
          ("fraction" === s.type &&
            (c.find(ys(s.currentClass)).text(s.formatFractionCurrent(d + 1)),
            c.find(ys(s.totalClass)).text(s.formatFractionTotal(p))),
          "progressbar" === s.type)
        ) {
          let t;
          ...
          "horizontal" === t ? (i = n) : (r = n),
            c
              .find(ys(s.progressbarFillClass))
      ...
      function d() {
        ...
        if ("bullets" === t.type) {
          ...
          i.html(r), (e.pagination.bullets = i.find(ys(t.bulletClass)));
        }
        "fraction" === t.type &&
          ((r = t.renderFraction
      ...
      function p() {
        ...
        0 !== s.length &&
          (e.params.uniqueNavElements &&
            ...
            ((s = e.$el.find(t.el)),
            s.length > 1 &&
              (s = s.filter((t) => _t(t).parents(".swiper")[0] === e.el))),
          ...
          t.clickable &&
            s.on("click", ys(t.bulletClass), function (t) {
              t.preventDefault();
              let s = _t(this).index() * e.params.slidesPerGroup;
      ...
      function u() {
        ...
        s.removeClass(t.hiddenClass),
          ...
          t.clickable && s.off("click", ys(t.bulletClass));
      }
      s("init", () => {
        p(), d(), c();
      }),
        ...
        s("click", (t, s) => {
          ...
          if (
            ...
            r.length > 0 &&
            !_t(i).hasClass(e.params.pagination.bulletClass)
          ) {
            if (
              e.navigation &&
    ...
    function Ss({ swiper: e, extendParams: t, on: s }) {
    ...
    function Es({ swiper: e, extendParams: t, on: s }) {
      ...
      function r() {
        ...
        const s = t.clickedIndex,
          n = t.clickedSlide;
        if (n && _t(n).hasClass(e.params.thumbs.slideThumbActiveClass)) return;
        if (null == s) return;
        let i;
        if (
          ((i = t.params.loop
            ? parseInt(_t(t.clickedSlide).attr("data-swiper-slide-index"), 10)
            : s),
          e.params.loop)
        ) {
          let t = e.activeIndex;
      ...
      !(function () {
        if (
          ...
          document.querySelector(".products-slider") &&
            new gs(".products-slider__slider", {
              modules: [bs, ws, xs],
              autoplay: { delay: 3e3, disableOnInteraction: !1 },
              observer: !0,
              watchOverflow: !0,
    ...
    const Os = document.querySelectorAll(".sub-menu-catalog__block");
    var As;
    Os.length &&
      Os.forEach((e) => {
        ...
        async function s(t, s) {
          if (0 === (e ? f.getErrors(t) : 0)) {
            ...
            if (t.hasAttribute("data-ajax")) {
              ...
              const a = await fetch(n, { method: i, body: r });
              if (a.ok) {
                await a.json();
      ...
      (As = !1),
      (u.selectModule = new p({ logging: As }));
  })();
})();
